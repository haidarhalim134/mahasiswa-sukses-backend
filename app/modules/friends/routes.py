...
async def list_friends(
    ...
    return await get_friends_list_service(db, current_user_id)
...
async def friend_summary(
    ...
    return await get_friend_summary_service(db, current_user_id)
...
async def list_friends_request(
    ...
    return await get_pending_requests_service(db, current_user_id)
...
async def accept_friend(
    ...
    return await accept_friend_request_service(db, current_user_id, requester_id)
...
async def deny_friend(
    ...
    return await deny_friend_request_service(db, current_user_id, requester_id)
...
async def remove_friend(
    ...
    return await remove_friend_service(db, current_user_id, friend_id)